...
/**
 * NotificationCardFull - Full notification card with wrapped text
 * Used in notification page where full content display is needed
 */
export const NotificationCardFull = ({
  notif,
  onClick,
...
NotificationCardFull.Skeleton = function NotificationCardFullSkeleton() {
  return (
